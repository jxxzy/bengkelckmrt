        ...
        <div class="row">
            <div class="col-width-25 custom-common-column">
                <div class="footer-widget footer-about-2 mb-40">
                    ...
                    <p>Copyright CKMRTOFFICIAL ©<span id="footer-cr-years"></span>. All rights reserved.</p>
                    </p>
                </div>
            </div>
            ...
            <div class="col-width-31 custom-common-column">
                <div class="footer-widget mb-40">
                    <h3 class="footer-title">Informasi Promo</h3>
                    <div class="app-visa-wrap">
                       <div class="search-style-1 d-none d-lg-block pb-30">
                        ...
                        <div class="payment-img">
                            <a href="#"><img src="<?= base_url(); ?>assets/home/assets/images/icon-img/payment-method.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
