              ...
              <div class="custom-common-column custom-column-width-66 custom-padding-5">
                  <div class="slider-area">
                      <div class="hero-slider-active-1 nav-style-1 nav-style-1-position-1">
                          ...
                          <div class="single-hero-slider single-animation-wrap slider-height-1 custom-d-flex custom-align-item-end bg-img" style="background-image:url(<?= base_url(); ?>assets/home/assets/images/bannertoko.jpg);">
                              <div class="hero-slider-content-1 slider-animated-1">
                                <!-- Sesuaikan Color (Font) dengan Gambar Banner agar tampak lebih rapih -->
                                  <h1 style="color: #333!important;" class="animated">Produk Terbaik dari<br><?= $this->Settings_model->general()["app_name"]; ?> </h1>
                                  <p  style="color: #DC143C!important;" class="animated">Dapatkan Produk dari kami dengan Harga yang cocok dan kualitas terbaik. Selamat Berbelanja!</p>
