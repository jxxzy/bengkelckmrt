                ...
                <div class="row align-items-center">
                    <div class="col-lg-2 col-md-4 col-6 col-sm-4">
                        <div class="single-brand-logo mb-30">
                            <img src="<?= base_url(); ?>assets/home/assets/images/brand-logo/bran-logo-1.png" alt="Partner">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-6 col-sm-4">
                        <div class="single-brand-logo mb-30">
                            <img src="<?= base_url(); ?>assets/home/assets/images/brand-logo/bran-logo-2.png" alt="Partner">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-6 col-sm-4">
                        <div class="single-brand-logo mb-30">
                            <img src="<?= base_url(); ?>assets/home/assets/images/brand-logo/bran-logo-3.png" alt="Partner">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-6 col-sm-4">
                        <div class="single-brand-logo mb-30">
                            <img src="<?= base_url(); ?>assets/home/assets/images/brand-logo/bran-logo-4.png" alt="Partner">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-6 col-sm-4">
                        <div class="single-brand-logo mb-30">
                            <img src="<?= base_url(); ?>assets/home/assets/images/brand-logo/bran-logo-5.png" alt="Partner">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-6 col-sm-4">
                        <div class="single-brand-logo mb-30">
                            <img src="<?= base_url(); ?>assets/home/assets/images/brand-logo/bran-logo-6.png" alt="Partner">
                        </div>
                    </div>
                </div>
            </div>
